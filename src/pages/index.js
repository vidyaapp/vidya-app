    ...
    <>
      ...
      <div className="font-sans">
          ...
          <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-col md:flex-row gap-10 justify-center">
              <div className="flex-1">
                ...
                <p>
                  Create your free account to get started with VidyaviharApp.
                </p>
              </div>
              <div className="flex-1">
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-10">
              <div className="bg-gray-100 p-6 rounded-xl">
                <p className="italic">
                  "VidyaviharApp completely changed the way I study! Live
                  classes are super interactive and effective."
                </p>
                <h4 className="mt-4 font-semibold">- Ananya Singh</h4>
              </div>
              <div className="bg-gray-100 p-6 rounded-xl">
                <p className="italic">
                  "Thanks to VidyaviharApp, I cracked my entrance exam with
                  flying colors. Highly recommend!"
                </p>
        ...
        <footer className="py-10 bg-gray-800 text-white text-center">
          <p>
            &copy; {new Date().getFullYear()} VidyaviharApp. All rights
            reserved.
          </p>
        </footer>
      </div>
